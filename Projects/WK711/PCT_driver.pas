...
begin
  ...
  try
    ...
    if Regs.OpenKey('\SOFTWARE\WayTech\Versato\Environment', True) then begin
      ...
      StatusBar1.Panels[0].Text := 'Zmìny byly uloženy do registru.';
      read_registry(Form1);
      clear_form(Form1);
    end;
    end;
...
begin
    ...
    StatusBar1.Panels[0].Text := 'Vítejte v programu Key Changer (c) Teuzz 2005';
end;
...
begin
     ...
     StatusBar1.Panels[0].Text := 'Pøed ukonèením programu nezapomeòte uložit provedené zmìny!';
end;
